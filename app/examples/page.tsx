...
export default function ExamplesPage() {
  ...
  const books = [
    ...
    },
    {
      ...
      genre: 'business',
      genreLabel: 'Wellbeing & Executive Routine',
      pages: 196,
      trim: '5.5 × 8.5 in',
      model: 'Claude 3.5 Sonnet + Data Visualizer',
      rating: '4.8',
      desc: 'Morning contemplation frameworks, intentional silence architectures, and restorative journal prompts for focused creative work.',
      image: '/images/cover-mindful-morning.jpg',
      demoUrl: '/examples/mindful-morning',
      prompt: 'A comprehensive handbook of morning rituals, reflective journaling prompts, and intentional focus habits.',
    },
    {
      slug: 'flavours-home',
      title: 'Flavours of Home: Mediterranean Secrets',
      genre: 'culinary',
    ...
    },
    {
      ...
      genre: 'children',
      genreLabel: "Children's Illustrated Folio",
      pages: 32,
      trim: '8.5 × 8.5 in',
      model: 'Claude 3.5 Sonnet + Flux Pro',
      rating: '5.0',
      desc: 'An enchanting bedtime voyage across starlit nebulae and whispering moons with full-page storybook watercolor plates.',
      image: '/images/cover-star-explorer.jpg',
      demoUrl: '/examples/star-explorer',
      prompt: 'A bedtime picture book about a little astronaut boy exploring colorful nebulae with his telescope.',
    },
  ];
