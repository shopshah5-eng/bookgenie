...
export default function BookResultPage({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F8F5EE] text-[#1A1612] relative overflow-x-hidden">
      {/* Editorial Header */}
      ...
      <main className="flex-1 flex flex-col items-center justify-between p-4 sm:p-8 max-w-4xl mx-auto w-full">
                ...
                {activePage.blocks.map((block) => {
                  ...
                  if (block.type === 'image') {
                    return (
                      <div
                        key={block.id}
                        className="my-4 p-4 rounded-2xl bg-[#F8F4EC] border border-[#EAE1D0] flex flex-col items-center text-center"
                      >
                        ...
                        <span className="text-xs font-semibold text-[#8C5F2E] mb-1">
                          Illustrated Artwork
                        </span>
        ...
        <div className="flex items-center gap-6 mt-6 pb-20 select-none">
          <button
            ...
            className="flex items-center gap-1 text-xs sm:text-sm font-semibold text-[#1A1612] disabled:text-[#C5BEB3] disabled:cursor-not-allowed hover:text-[#9A6F3C] transition-colors"
          >
