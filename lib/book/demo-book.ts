...
export function getStarExplorerDemoBook(): BookDocument {
  return {
    ...
    blueprint: {
      ...
      pageTarget: 8,
      chapters: [
        { index: 1, title: 'The Starlight Pocket', summary: 'Leo finds a tiny luminous star sleeping inside his telescope.', allocatedPages: 2 },
        { index: 2, title: 'Sailing the Milky Stream', summary: 'Building a cardboard rocket powered by bedtime giggles.', allocatedPages: 2 },
        { index: 3, title: 'The Cloud of Whispering Comets', summary: 'Friendly comets playing hide-and-seek among Saturn rings.', allocatedPages: 2 },
        { index: 4, title: 'Safe Return to the Moonbeam Cradle', summary: 'Tucking the little star into bed beneath starry quilts.', allocatedPages: 2 },
      ],
      visualPlan: [
    ...
    pages: [
      ...
      },
      {
        pageNumber: 5,
        chapterIndex: 2,
        title: 'Across the Nebula',
        pageType: 'content',
        layout: 'standard',
        blocks: [
          { id: 'se-11', type: 'heading', level: 2, text: 'Dancing on Cosmic Dust' },
          { id: 'se-12', type: 'paragraph', text: 'Colors swirled around them like warm watercolor paints—magenta clouds of hydrogen, teal trails of solar wind, and golden dust motes that chimed whenever the ship passed through.' },
          { id: 'se-13', type: 'quote', text: '“Look, Astro! The stars are humming their lullaby.”' },
        ],
      },
      {
        pageNumber: 6,
        chapterIndex: 3,
        title: 'The Whispering Comets',
        pageType: 'chapter_header',
        layout: 'standard',
        blocks: [
          { id: 'se-14', type: 'heading', level: 1, text: 'Chapter 3: The Cloud of Whispering Comets' },
          { id: 'se-15', type: 'paragraph', text: 'Three playful comets swooped past in silver arcs, leaving ice-crystal trails that sparkled like diamonds. Leo steered through the crystalline hoops, laughing as cosmic glitter dusted his space boots.' },
        ],
      },
      {
        pageNumber: 7,
        chapterIndex: 4,
        title: 'The Moonbeam Cradle',
        pageType: 'chapter_header',
        layout: 'standard',
        blocks: [
          { id: 'se-16', type: 'heading', level: 1, text: 'Chapter 4: The Moonbeam Cradle' },
          { id: 'se-17', type: 'paragraph', text: 'High above the quiet Earth, the crescent moon tilted like a giant rocking chair. Leo gently placed the tiny glowing star inside a crater lined with soft stardust.' },
          { id: 'se-18', type: 'paragraph', text: '“Sleep tight, little one,” Leo whispered. The star pulsed once with warm amber light, safe in its celestial nursery.' },
        ],
      },
      {
        pageNumber: 8,
        chapterIndex: 4,
        title: 'Home for Bedtime',
        pageType: 'content',
        layout: 'standard',
        blocks: [
          { id: 'se-19', type: 'heading', level: 2, text: 'Safe in Bed' },
          { id: 'se-20', type: 'paragraph', text: 'Drifting down through the attic window, Leo slipped under his quilt just as morning twilight painted the rooftop silver. On his nightstand, the brass telescope was quiet—ready for the next voyage.' },
          { id: 'se-21', type: 'quote', text: 'End of BookGenie Showcase Edition • The Little Star Explorer' },
        ],
      },
    ],
  };
